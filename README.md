...
- Relatório PDF: o botão abre uma **tela de emissão** onde se escolhem os tipos de ocorrência (com a
  quantidade de cada um) e se o registro fotográfico entra. Os demais filtros vêm da tela do painel.
